...
\definecolor{lightyellow}{HTML}{fef7a5}
...
\tikzset{
    ...
    indexed array/.style = {matrix of nodes, column sep=-\pgflinewidth, row 1/.style={nodes=index, row sep=.15\cellsize}, row 2/.style={nodes=cell}, nodes in empty cells},
