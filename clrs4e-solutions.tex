...
\newlength{\vertexsize}
\setlength{\vertexsize}{1.3em}
\newlength{\cellsize}
\setlength{\cellsize}{1.3em}

\tikzset{
    >={Stealth[scale length=1.5, scale width=1.25]},
    vertex/.style = {circle, font=\footnotesize, minimum size=\vertexsize, text height=1ex, text depth=.1ex, inner sep=1pt},
    ...
    cell/.style = {draw, font=\footnotesize, minimum size=\cellsize, text height=1ex, text depth=.1ex, inner sep=1pt},
