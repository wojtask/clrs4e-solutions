...
% TODO(#1582) find a way to get rid of this magic constant
\newlength{\exerciselabelmarginwidth}
\setlength{\exerciselabelmarginwidth}{.73\lmarginparwidth}
...
\renewcommand{\chapter}[1]{%
    \originalchapter{#1}
    \titleformat{\section}[display]{\large\bfseries}{}{0pt}{\titlerule[\thinrulethickness]\vspace{3pt}\probablestar\thesection\hspace\labelsep}
    \titleformat{\subsection}[runin]{\bfseries\itshape}{\makebox[\exerciselabelmarginwidth][l]{\thesubsection}}{0pt}{}
    \titlespacing*{\subsection}{-\exerciselabelmarginwidth}{*3}{0pt}
    \renewcommand{\thesection}{\thechapter.\arabic{section}}
    \fancyhead[LO]{\nouppercase{\footnotesize\textit{\rightmark}}}
}
...
\newcommand{\problems}{%
    ...
    \titleformat{\subsection}[hang]{\bfseries\itshape}{\makebox[\exerciselabelmarginwidth][l]{\thesubsection}}{0pt}{}
    \titlespacing*{\subsection}{-\exerciselabelmarginwidth}{*3}{*2}
...
\makeatletter
\newcommand{\st@rred}[1]{\rlap{\protect\makebox[#1][r]{\customstar}\vspace*{-\baselineskip}}}
\newcommand{\starred}{%
    % thesection>0 in exercises, thesection=0 is problems
    % TODO(#1582) find a way to get rid of these magic constants
    \ifnum\value{section}>0%
        \st@rred{-.885\lmarginparwidth}%
    \else%
        \st@rred{-.155\lmarginparwidth}%
    \fi}
\makeatother
...
\newtheoremstyle{clrs}{}{}{}{}{\bfseries\itshape}{}{\newline}{\thmname{#1}\thmnumber{\bfseries\itshape{ #2}}\thmnote{ (#3)}}
\theoremstyle{clrs}
