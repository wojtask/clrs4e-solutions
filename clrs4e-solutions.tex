...
\tikzset{
    vertex/.style = {circle, font=\footnotesize, inner sep=1pt, minimum size=5mm, text height=1ex, text depth=.1ex},
    ...
    index/.style = {font=\scriptsize, inner sep=0pt, minimum size=3mm, text height=1.5ex},
    arrow/.style = {->, >={Stealth[scale=1.5, bend]}, draw},
