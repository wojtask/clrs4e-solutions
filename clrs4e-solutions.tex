...
\newcommand{\MakeChapter}[3]{%
    ...
    \foreach \Title [count=\Section] in {#2}{%
        ...
        \foreach \Exercise in {1,...,16}{%
            \IfFileExists{\thestring/sections/\Section/\Exercise}{%
                \exercise
                \import{\thestring/sections/\Section/}{\Exercise}
            }{}%
        }%
    }%
    \problems
    \foreach \Title [count=\Problem] in {#3}{%
        \problem{\Title}
        \IfFileExists{\thestring/problems/\Problem/main}{%
            \import{\thestring/problems/\Problem/}{main}
        }{}%
        \foreach \SubProblem in {a,...,j}{%
            \IfFileExists{\thestring/problems/\Problem/\SubProblem}{%
                \subproblem
                \import{\thestring/problems/\Problem/}{\SubProblem}
            }{}%
        }%
        \IfFileExists{\thestring/problems/\Problem/main_end}{%
            \par\bigskip\import{\thestring/problems/\Problem/}{main_end}
        }{}%
    }%
}
