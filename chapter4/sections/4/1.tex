...
To prove this bound we adopt the inductive hypothesis that $T(n)\le c3^n-d$ for some constants $c$, $n_0>0$ and $d\ge0$, and assume that the inductive hypothesis holds for all numbers at least as big as $n_0$ and less than $n$.
...
\begin{figure}[!htb]
    \subcaptionbox{\label{fig:4.4-1a}}[\textwidth]{\input{1a.tikz}}
    \par\vspace{10mm}
    \subcaptionbox{\label{fig:4.4-1b}}[\textwidth]{\input{1b.tikz}}
    \caption{
...
\begin{figure}[htb!]\ContinuedFloat
    \subcaptionbox{\label{fig:4.4-1c}}[\textwidth]{\input{1c.tikz}}
    \par\vspace{10mm}
    \subcaptionbox{\label{fig:4.4-1d}}[\textwidth]{\input{1d.tikz}}
    \caption{
