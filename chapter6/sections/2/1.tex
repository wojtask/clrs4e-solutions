...
\begin{figure}[htb]
    ...
    \subcaptionbox{\label{fig:6.2-1a}}[0.5\textwidth]{\input{1a.tikz}}
    \subcaptionbox{\label{fig:6.2-1b}}[0.5\textwidth]{\input{1b.tikz}}
    \par\vspace{5mm}
    \subcaptionbox{\label{fig:6.2-1c}}[0.5\textwidth]{\input{1c.tikz}}
