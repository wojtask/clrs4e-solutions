Let $n\ge3$ and let $S=\{s_{pq}:1\le p,q\le n\}$ be a sample space with the uniform probability distribution (i.e., $\prob{s_{pq}}=1/n^2$ for every $p=1$, 2, \dots, $n$ and $q=1$, 2, \dots, $n$).
